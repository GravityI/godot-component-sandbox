...
Setup:
	...
	- Script the different states of the object according to your needs, inheriting from the State class defined in "state.gd" (which also contains comments explaining the two main methods of the State class).
